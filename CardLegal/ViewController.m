...
//  CardLegal
//
//  Created by LiLong on 16/7/28.
//  Copyright © 2016年 ecshcec. All rights reserved.
//
...
- (IBAction)validation:(id)sender {
  ...
  BOOL isNo =  [self validateIDCardNumber:self.cardIdTextField.text];
    
    if (isNo) {
        self.resultsLable.text = @"正确的身份证号";
    }else{
        self.resultsLable.text = @"不合法的身份证号";
